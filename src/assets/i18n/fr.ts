export const FR = {
    NAV: {
      ...
      HURGHADA_TOURS: 'Excursions à Hurghada',
      CAIRO_TOURS: 'Excursions au Caire',
      LUXOR_TOURS: 'Excursions à Louxor',
      SAFARI_TOURS: 'Excursions Safari',
      SEA_TOURS: 'Excursions en mer',
      THINGS_TO_DO_HURGHADA: 'Activités à Hurghada',
      PRODUCTS: 'Produits',
      BRANDS: 'Marques',
      CATEGORIES: 'Catégories'
    },
    FOOTER: {
      DESC: "Découvrez la beauté de l'Égypte avec nos excursions sélectionnées, visites privées, sorties en mer Rouge, safaris dans le désert et aventures historiques au Caire, Louxor et au-delà.",
      QUICK_LINKS: 'Liens rapides'
    },
    SECTION: {
      DISCOVER_JOURNEY: 'Découvrez votre prochain voyage',
      EXPLORE_TOURS: 'Explorez des excursions inoubliables',
      DESC: "Expériences soigneusement sélectionnées, destinations à couper le souffle et circuits conçus pour transformer vos voyages en souvenirs impérissables.",
      TRANSFER_SERVICES: 'Nos services de transport'
    },
    HERO: {
    ...
    TRANSFER: {
      NO_TRANSFERS_TITLE: 'Aucun transport disponible',
      NO_TRANSFERS_DESC: 'Revenez plus tard pour de nouveaux forfaits de transport',
      DESCRIPTION: 'Description du transport',
      HIGHLIGHTS: 'Points forts',
      PRICES: 'Tarifs des transports',
      TABLE: {
        TITLE: 'Titre',
        PRIVATE: 'Privé',
        SHARED: 'Partagé'
      },
      LOADING: 'Chargement des détails du transport...',
      INCLUDED: 'Inclus',
      NOT_INCLUDED: 'Non inclus'
    },
    TOUR: {
      DESCRIPTION: 'Description de l’excursion',
      DURATION: 'Durée',
      START_LOCATION: 'Lieu de départ',
      END_LOCATION: 'Lieu de retour',
      LANGUAGES: 'Langues',
      GALLERY: 'Galerie de l’excursion',
      HIGHLIGHTS: 'Points forts de l’excursion',
      INCLUDED: "Ce qui est inclus",
      NOT_INCLUDED: "Ce qui n'est pas inclus",
      VIDEO_TITLE: 'Vidéo de l’excursion'
    },
    INFO: {
      KNEW_BEFORE_GO: 'À savoir avant de partir',
      LIST: {
        
    PASSPORT_COPY: 'Veuillez fournir une copie de votre passeport pour l’autorisation quotidienne.',
    SHOPPING_TIME: 'Un temps libre pour le shopping est prévu, vous permettant de profiter de l’expérience et de négocier les prix directement avec les vendeurs.'
      ,
        ...
        CHILDREN_SUPERVISION: 'Les enfants doivent être accompagnés d’un adulte. L’excursion n’est pas recommandée pour les nourrissons de moins de 3 ans.'
      }
    },
    PAYMENT: {
      TITLE: 'Politique de paiement',
      LIST: {
        RESERVE_PAY_LATER: 'Réservez maintenant et payez plus tard',
        CURRENCY: 'La devise des prix est l’Euro, mais vous pouvez payer en USD ou Livre Sterling',
        PRICES: 'Les prix sont indiqués par personne et par excursion et sont toujours mis à jour pour vous garantir le meilleur prix possible',
        QUALITY: 'D’autres peuvent proposer des prix moins chers, mais nous promettons une qualité inégalée, un service personnalisé et une expérience mémorable.'
      }
    },
    RESERVATION: {
      PROTECTED: 'Les détails de votre réservation sont protégés'
    },
    ABOUT: {
      ...
      FEATURES: {
        ...
        GUIDES: 'Guides professionnels et expérimentés',
        TRIPS: 'Voyages personnalisés pour tous les budgets'
      },
      BUTTON: 'En savoir plus'
    },
    Review: 'Lisez ce que disent nos voyageurs — et partagez votre propre expérience avec nous !',
    BLOGS: {
      TITLE: "Blog de voyage",
      SUBTITLE: "Récits de voyage inspirants, conseils et guides par TopPicksTravels",
    ...
    ABOUT_: {
      ...
      FEATURES: {
        QUALITY: {
          ...
          TEXT: "Nous offrons des excursions et services soigneusement sélectionnés pour garantir les normes les plus élevées de qualité et de confort."
        },
        TEAM: {
          TITLE: "Équipe expérimentée",
          TEXT: "Notre équipe est composée d'experts en tourisme et de guides locaux avec une connaissance approfondie et une passion pour le voyage."
        },
        TRUST: {
          TITLE: "De confiance et fiable",
          TEXT: "Nous croyons en la transparence, la fiabilité et la construction de relations à long terme avec nos clients."
        }
      }
    },
    HeroDiscription: "Découvrez votre prochaine aventure",
    WhyChooseUsTitle: "Pourquoi nous choisir",
    WhyChooseUsSubtitle: "Raisons brillantes",
    Service1Title: "Visites guidées par des experts",
    Service1Description: "Découvrez les merveilles antiques et les trésors historiques avec nos guides professionnels certifiés.",
    Service1Link: "Explorer les excursions",
    Service2Title: "Magnifiques excursions balnéaires",
    Service2Description: "Profitez des plus belles plages de la mer Rouge et de la Méditerranée avec des excursions parfaitement organisées.",
